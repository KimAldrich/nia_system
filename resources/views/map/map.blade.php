...
@section('content')
    ...
    <<<<<<< HEAD <style>
        ...
        <style>
            ...
            >>>>>>>df7b86d84f7bf24ce3027fa24c6c2e3904b75b09
        ...
        <form id="uploadForm" enctype="multipart/form-data">
            ...
            <div id="map-container">
                ...
                <div id="layer-controls">
                    <label class="layer-check" style="background-color: green; color: white;">
                        <input type="checkbox" id="toggleIrrigated"
                            {{ empty($overlayGroups['irrigated']['files']) ? 'disabled' : '' }}>
                        <span>Irrigated Area</span>
                    </label>
                    <label class="layer-check" style="background-color: blue; color: white;">
                        <input type="checkbox" id="toggleLandBoundary"
                            {{ empty($overlayGroups['land_boundary']['files']) ? 'disabled' : '' }}>
                        <span>Land Boundary</span>
                    </label>
                    <label class="layer-check" style="background-color: yellow;">
                        <input type="checkbox" id="togglePotential"
                            {{ empty($overlayGroups['potential']['files']) ? 'disabled' : '' }}>
                ...
                <div id="map-status">Tick a layer to load the uploaded polygons from <code>storage/app/public/maps</code>.
                </div>
                <div id="miniMap"></div>
            </div>
            ...
            <script src="https://cdn.jsdelivr.net/npm/@tmcw/togeojson@5.8.1/dist/togeojson.umd.min.js" crossorigin="anonymous">
            </script>
                        ...
                        onEachFeature: function(feature, layer) {
                            ...
                            layer.on('click', function(e) {
                                ...
                                Object.values(overlayLayers).forEach(group => {
                                    group.eachLayer(l => {
                                        if (l !== layer) {
                                            l.setStyle(styleOverlayFeature(categoryKey, l
                                                .feature));
                                        }
                                    });
                                });
        ...
        <form id="uploadForm" enctype="multipart/form-data">
            ...
            <div id="map-container">
                ...
                <div id="map-status">Tick a layer to load the uploaded polygons from
                    <code>storage/app/public/maps</code>.</div>
                <div id="miniMap"></div>
            </div>
