...
@section('content')
    ...
    <h1 class="header-title">Social and Environmental Team Files</h1>
    <p class="header-desc">Manage and upload social and environmental team files for the regional office and field offices.
    </p>
                    ...
                    <div style="display: flex; gap: 8px; margin-bottom: 15px;">
                        ...
                        @if (auth()->check() && in_array(auth()->user()->role, ['rpwsis_team', 'admin']))
                            <form action="{{ route('rpwsis.resolutions.delete', $resolution->id) }}" method="POST"
                                style="margin: 0;" data-async-target="#resolutionsList"
