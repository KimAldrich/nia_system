...
@section('content')
            ...
            @forelse($files as $file)
                ...
                <div class="ui-card">
                    ...
                    <div style="display: flex; gap: 8px; margin-bottom: 15px;">
                        ...
                        @if(auth()->check() && in_array(auth()->user()->role, ['pcr_team', 'admin']))
                            <form action="{{ route('pcr.downloadables.delete', $file->id) }}" method="POST" style="margin: 0;">
                                @csrf
                                @method('DELETE')
    ...
    <div id="upload-form" class="tab-pane">
        <form action="{{ route('pcr.downloadables.upload') }}" method="POST" enctype="multipart/form-data">
            @csrf
