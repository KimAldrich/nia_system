...
@section('content')
    ...
    <h1 class="header-title">Program Completion Report Team Files</h1>
    <p class="header-desc">Manage and upload program completion report team files for the regional office and field offices.
    </p>
    ...
    <div id="upload-resolution" class="tab-pane">
        <form action="{{ route('pcr.resolutions.upload') }}" method="POST" enctype="multipart/form-data"
