...
@section('content')
    ...
    <h1 class="header-title">Contract Management Team Files</h1>
    <p class="header-desc">Manage and upload contract management team files for the regional office and field offices.</p>
