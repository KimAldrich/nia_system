...
@section('content')
    ...
    <h1 class="header-title">Right of Way Files</h1>
    <p class="header-desc">Manage and upload right of way files for the regional office and field offices.</p>
    ...
    <div id="upload-resolution" class="tab-pane">
        <form action="{{ route('row.resolutions.upload') }}" method="POST" enctype="multipart/form-data"
