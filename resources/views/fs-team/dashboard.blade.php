    ...
    <div class="ui-card">
        <div class="section-title">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <button
                    style="background: #4f46e5; color: white; border: none; padding: 8px 16px; border-radius: 8px; font-family: 'Poppins', sans-serif; font-size: 12px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 8px;">
        ...
        <div class="table-responsive">
            <table class="sleek-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" style="text-align:center; padding: 30px 0; color: #a0aec0;">No projects
        ...
        @if (isset($hydroProjects) && $hydroProjects->hasPages())
            <div class="custom-pagination">
                ...
                @else
                    <a href="{{ $hydroProjects->previousPageUrl() }}" class="page-item"><svg fill="none"
                ...
                @if ($hydroProjects->hasMorePages())
                    <a href="{{ $hydroProjects->nextPageUrl() }}" class="page-item"><svg fill="none"
                            stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <form action="{{ route('fs.hydro.store') }}" method="POST">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="district" required placeholder="e.g. 1st District"
                            class="modern-input">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="system_name" required placeholder="e.g. Alilao SPIP"
                        class="modern-input">
                </div>

                <div>
                    <label class="modern-label">Description / Remarks</label>
                    <textarea name="description" required rows="3" class="modern-input" style="resize: none;"
