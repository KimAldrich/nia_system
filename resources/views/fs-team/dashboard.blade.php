                                ...
                                <tr>
                                    ...
                                    @if (auth()->check() && in_array(auth()->user()->role, ['fs_team', 'admin']))
                                        <td style="text-align: right;">
                                            <form action="{{ route('fs.resolutions.update_status', $res->id) }}" method="POST" onsubmit="return handleAjaxSubmit(event, 'activeProjectsContainer')">
                                                @csrf
    ...
    <div class="ui-card" style="margin-top: 24px;">
        <div class="section-title">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <button onclick="exportHydroToExcel()" style="background: #16a34a; color: white; border: none; padding: 8px 16px; border-radius: 8px; font-family: 'Poppins', sans-serif; font-size: 12px; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 8px;">
