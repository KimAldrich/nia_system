            ...
            @forelse($resolutions as $resolution)
                ...
                <div class="ui-card">
                    ...
                    <div style="display: flex; gap: 8px; margin-bottom: 15px;">
                        ...
                        <!-- DELETE BUTTON -->
                        @if (auth()->check() && in_array(auth()->user()->role, ['fs_team', 'admin']))
                            <form action="{{ route('fs.resolutions.delete', $resolution->id) }}" method="POST" style="margin: 0;" data-async-target="#resolutionsList" data-async-confirm="Delete this resolution?">
                                @csrf
                                @method('DELETE')
