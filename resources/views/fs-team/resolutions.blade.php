...
@section('content')
    ...
    <div id="upload-resolution" class="tab-pane">
        <form action="{{ route('fs.resolutions.upload') }}" method="POST" enctype="multipart/form-data" data-async-target="#resolutionsList" data-async-reset="true" data-async-success-modal="#fsFeedbackModal" data-async-success-title="Upload Complete" data-async-error-modal="#fsFeedbackModal" data-async-error-title="Upload Failed">
            @csrf
