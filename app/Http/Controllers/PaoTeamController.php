...
class PaoTeamController extends Controller
{
    ...
    {
        $resolutions = IaResolution::with('files')->where('team', 'pao_team')->latest()->get();
        return view('shared.team-resolutions', [
            'pageTitle' => 'Program of Works Files',
            'headerTitle' => 'Program of Works Files',
            'headerDesc' => 'Manage status entries and attached files for Programming.',
            'teamRole' => 'pao_team',
            'uploadRouteName' => 'pao.resolutions.upload',
            'deleteRouteName' => 'pao.resolutions.delete',
    ...
    public function uploadResolution(Request $request)
    {
        ...
        foreach ($files as $file) {
            ...
            IaResolution::attachUploadedFile($file, 'pao_team');
        }
